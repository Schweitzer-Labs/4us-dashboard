...
createContributionModal model =
    PlatformModal.view
        ...
        , successViewActive = False
        , successViewMessage = ""
        , isSubmitDisabled = not <| ContribInfo.toSubmitDisabled model.createContributionModal
...
contribRuleVerifiedModal model =
    PlatformModal.view
        ...
        , successViewMessage = " Revision Successful!"
        , isSubmitDisabled = not <| ContribInfo.toSubmitDisabled model.contribRuleVerifiedModal
