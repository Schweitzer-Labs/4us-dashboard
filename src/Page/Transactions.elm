...
init config session aggs committee committeeId =
    let
        initModel =
            ...
            , disbRuleUnverifiedModal = Tuple.first <| DisbRuleUnverified.init config session Transaction.init
...
createDisbursementModal model =
    PlatformModal.view
        ...
        , successViewMessage = ""
        , isSubmitDisabled = not <| CreateDisbursement.toSubmitDisabled model.createDisbursementModal
...
createContributionModal model =
    PlatformModal.view
        ...
        , successViewActive = False
        , successViewMessage = ""
        , isSubmitDisabled = not <| ContribInfo.toSubmitDisabled (CreateContribution.validationMapper model.createContributionModal)
...
openTxnFormModalLoading model txn =
    case TxnForm.fromTxn txn of
        TxnForm.DisbRuleUnverified ->
            let
                ( subModel, subMsg ) =
                    DisbRuleUnverified.init model.config model.session txn
                    ...
                    case mutResp of
                        Success id ->
                            ( { model
                                ...
                                , disbRuleUnverifiedModal = Tuple.first <| DisbRuleUnverified.init model.config model.session model.disbRuleUnverifiedModal.bankTxn
                              }
                            , getTransactions model Nothing
                            )
