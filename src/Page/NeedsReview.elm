...
update msg model =
    case msg of
        ...
        CheckAmountUpdated str -> ({model | createDisbursementModalAmount = str}, Cmd.none)
        CheckRecipientUpdated str -> ({model | createDisbursementModalVendorName = str}, Cmd.none)
        CheckNumberUpdated str -> ({model | createDisbursementModalCheckNumber = str}, Cmd.none)
        CheckDateUpdated str -> ({model | createDisbursementDate = str}, Cmd.none)
